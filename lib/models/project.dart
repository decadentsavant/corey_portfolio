...
class Project {
  ...
  final String title, subtitle, description, url, imageLocation;
}
...
List<Project> portfolioProjects = [
  Project(
    ...
    imageLocation: 'https://github.com/decadentsavant/corey_portfolio',
  ),
  Project(
    title: 'Most Learned',
    subtitle: 'Mobile App',
    ...
    imageLocation: 'https://github.com/decadentsavant/ml_app',
  ),
  Project(
    ...
    url: 'backEndDartFrog',
    imageLocation: 'https://github.com/decadentsavant/dart_frog_playground_firebase',
  ),
  Project(
    ...
    url: 'blockchainChat',
    imageLocation: 'https://github.com/decadentsavant/flutter_dapp',
  ),
  Project(
      title: 'Coin Watcher',
      subtitle: 'Crypto App',
    ...
    imageLocation: 'https://github.com/RobertBrunhage/flutter-riverpod-snippets',
      ),
  Project(
    ...
    imageLocation: 'https://github.com/decadentsavant/crypto_app',
  ),
];
